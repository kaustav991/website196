...
<head>
    ...
    <link rel="stylesheet" href="css/slimNav_sk78.css" rel="stylesheet" type="text/css">
    ...
    <header>
        <div class="top-header">
            <div class="container">
                <div class="row">
                    <div class="col-md-9">
                        <h6>BOOK A CALL WITH OUR PRINCIPAL BROKER</h6>
                    </div>
                    <div class="col-md-3 text-md-center">
                        <a href="#"><img src="images/call.svg" alt=""> Call Now! 780 466 9898</a>
                    </div>
                </div>
            </div>
        </div>
